...
public class MailUtil {
     ...
     */
    public static void sendResetPwd(String ResetPwd,String receiveMailAccount) {
        try {

            sendTo("密码重置",ResetPwd,receiveMailAccount);
        }catch (Exception e){
   ...
   public static void sendRegisterCode(String code,String receiveMailAccount){
    ...
    public static void sendTo(String subject,String body, String receiveMailAccount) throws Exception {  //只需要传入正文和目标地址即可
        ...
        MimeMessage message = createMimeMessage(session,subject, myEmailAccount, receiveMailAccount, body);
